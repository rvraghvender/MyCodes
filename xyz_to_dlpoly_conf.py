...
print("This program converts the .xyz file format")
print()
...
print()
print("Remember to put some text in the second row of xyz file.")
print()
...
fw.write('CONFIG file created by Raghvender .xyz format ')
...
for i in range(3):
    fw.write(" \n % 5.9s  %7.9s  %7.9s  " % ("VECTOR[i][0]","VECTOR[i][1]","VECTOR[i][2]"))
